...
| 用户名 | 密码 | 权限说明 |
|--------|------|----------|
| admin | admin123 | 查看所有订单、管理所有商品、查看客户数据、删除订单 |

### 卖家账号
| 用户名 | 密码 | 权限说明 |
|--------|------|----------|
| seller1 | seller123 | 管理自己的商品、查看相关订单、订单发货、客户统计 |
| seller2 | seller123 | 管理自己的商品、查看相关订单、订单发货、客户统计 |

### 买家账号
| 用户名 | 密码 | 权限说明 |
|--------|------|----------|
| test | test123 | 浏览购买商品、管理购物车、下单支付、查看订单、评价商品 |
| buyer1 | buyer123 | 浏览购买商品、管理购物车、下单支付、查看订单、评价商品 |
| buyer2 | buyer123 | 浏览购买商品、管理购物车、下单支付、查看订单、评价商品 |

**快速测试建议**:
1. 使用 `test/test123` 体验完整购买流程
2. 使用 `seller1/seller123` 体验商品管理和订单发货
3. 使用 `admin/admin123` 体验系统管理功能
